...
// 13.验证交易签名
func (bc *Blockchain) VerifyTransaction(tx *core.Transaction) bool {
...
// 12.签名交易
func (blockchain *Blockchain) SignTransaction(tx *core.Transaction, privateKey ecdsa.PrivateKey) {
...
// 11.查找交易
func (bc *Blockchain) FindTransaction(ID []byte) (core.Transaction, error) {
	bci := bc.Iterator()
